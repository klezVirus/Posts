...
If you're not really interested to have this tool among your own toolset, I uploaded three files ready to use [here](http://www.redcrownsecurity/offensive-security/oswe/preparation/reviews/vulnhub/res/md5coll/). Those three files are different, but their md5 hashes are the same. To prove that, it's enough to run:
